...
class VoiceActivationTests(unittest.TestCase):
    def test_defaults_are_always_listening_and_omniroute_only(self):
    ...
    def test_only_addressed_speech_passes_transcript_gate(self):
    ...
    def test_duplicate_voice_sessions_are_rejected(self):
