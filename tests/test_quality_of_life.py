...
class QualityOfLifeTests(unittest.TestCase):
    ...
    def test_default_registry_names_are_stable(self) -> None:
        self.assertEqual(
            ...
            ("account_access", "applications", "background", "browser", "browser_registry", "clipboard", "cloud_router", "computer", "files", "gods_eye", "hand_control", "hand_control_server", "locations", "processes", "scheduler", "screen", "self_coding", "system", "windows", "windows_maintenance"),
        )
