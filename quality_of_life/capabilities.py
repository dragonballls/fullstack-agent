...
OPERATION_CATALOG: tuple[OperationSpec, ...] = (
    ...
    OperationSpec("background.cancel", Capability.BACKGROUND_JOBS, OperationRisk.MUTATE, "Cancel a bounded background job"),
    ...
    OperationSpec("youtube.video.upload", Capability.ACCOUNT_WRITE, OperationRisk.EXTERNAL, "Upload a video through an authorized account"),
