...
OPERATION_CATALOG: tuple[OperationSpec, ...] = (
    ...
    OperationSpec("family.locations", Capability.FAMILY_LOCATION_READ, OperationRisk.READ, "Read authorized family-member locations from a configured provider"),
    OperationSpec("family.member", Capability.FAMILY_LOCATION_READ, OperationRisk.READ, "Read one authorized family-member location"),
    OperationSpec("family.refresh", Capability.FAMILY_LOCATION_READ, OperationRisk.READ, "Refresh authorized family-member locations"),
    OperationSpec("family.follow", Capability.FAMILY_LOCATION_READ, OperationRisk.READ, "Follow one authorized family-member marker in God’s Eye"),
    OperationSpec("family.stop_follow", Capability.FAMILY_LOCATION_READ, OperationRisk.READ, "Stop following a family-member marker"),
